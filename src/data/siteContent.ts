...
export const services: Service[] = [
  { id: 'de13e87e-dce1-41d0-9b81-909d112e9567', name: 'General Consultation', description: 'Thorough wellness checks and expert guidance for everyday pet health concerns.', icon: 'Stethoscope', price_label: 'From ₹300', is_published: true, sort_order: 1 },
  { id: 'e5ccf25f-7515-426c-9980-1fcc764d0982', name: 'Vaccination', description: 'Complete core and lifestyle vaccination schedules to keep your pet protected.', icon: 'Syringe', price_label: 'From ₹400', is_published: true, sort_order: 2 },
  { id: '330ca895-8b45-435f-b819-46910dadd9ec', name: 'Surgery', description: 'Safe, modern surgical procedures performed with advanced equipment and monitoring.', icon: 'Scissors', price_label: 'On consultation', is_published: true, sort_order: 3 },
  { id: 'f736e9be-53af-4e06-a052-23aedb6443c0', name: 'Grooming', description: 'Bathing, trimming, and hygiene care to keep your pet clean, comfortable and happy.', icon: 'Sparkles', price_label: 'From ₹500', is_published: true, sort_order: 4 },
  { id: '348af232-5d1c-47bc-8a6b-60991faefb00', name: 'Pet Boarding', description: 'Safe, supervised short and long-term boarding while you\u2019re away from home.', icon: 'Home', price_label: 'From ₹600/day', is_published: true, sort_order: 5 },
  { id: '21507468-a62f-4acb-a442-809d25e76a59', name: 'Emergency Care', description: '24/7 emergency support for accidents, sudden illness, and urgent conditions.', icon: 'Siren', price_label: 'Call for priority', is_published: true, sort_order: 6 },
  { id: '7e0b9d0b-8336-4751-818a-48b382980ae', name: 'Diagnostics', description: 'In-house lab testing, imaging and screening for faster, more accurate diagnosis.', icon: 'Microscope', price_label: 'From ₹350', is_published: true, sort_order: 7 },
  { id: 'df6c26c4-c971-46e9-bab3-c3e1b6fd15d3', name: 'Pet Accessories', description: 'A curated range of food, collars, and care essentials for your pet.', icon: 'ShoppingBag', price_label: 'Varies', is_published: true, sort_order: 8 },
]
